    ...
    <div className="w-100 vh-100 d-flex justify-content-center align-items-center bg-dark">
      <div className="bg-white w-25 h-50 rounded-4 d-flex flex-column justify-content-evenly align-items-center px-4">
        ...
        <form className="w-100 d-flex flex-column justify-content-between align-items-center text-primary fs-5">
          <label className="w-100 text-start ps-3">Username</label>
          <input className="w-100 p-2 border-0 bg-light rounded-2" type="text" ref={userRef} title='type "user"' placeholder='"user"' />
          <label className="w-100 text-start ps-3">Password</label>
          <input className="w-100 p-2 border-0 bg-light rounded-2" type="password" ref={passRef} title='type "user"' placeholder='"user"' />
        </form>
